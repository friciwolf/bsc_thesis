...
\usepackage{physics} %using \bra - \ket
\usepackage{siunitx} %using \SI
...
\thesistitle{Study of the Reconstruction of Tau Decay Planes for a Higgs Boson CP Measurement} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\include{Chapters/IP1}
\include{Chapters/IP2}
\include{Chapters/conclusion+outlook}
%\include{Chapters/help}
